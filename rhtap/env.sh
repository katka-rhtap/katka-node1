...
export IMAGE_URL=${IMAGE_URL-https://nexus-docker-nexus.apps.rosa.rhtap-services.xmdt.p3.openshiftapps.com/rhtap/katka-rhtap-release-test:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/katka-rhtap/katka-node1-gitops
